...
use MetaBox\Dependencies\Twig\Node\BlockReferenceNode;
...
use MetaBox\Dependencies\Twig\Node\NodeCaptureInterface;
use MetaBox\Dependencies\Twig\Node\NodeOutputInterface;
use MetaBox\Dependencies\Twig\Node\PrintNode;
use MetaBox\Dependencies\Twig\Node\TextNode;
...
class Parser
{
    ...
    private function filterBodyNodes(Node $node, bool $nested = false): ?Node
    {
        ...
        if (
            ...
            throw new SyntaxError('A template that extends another one cannot include content outside MetaBox\Dependencies\Twig blocks. Did you forget to put the content inside a {% block %} tag?', $node->getTemplateLine(), $this->stream->getSourceContext());
        }
