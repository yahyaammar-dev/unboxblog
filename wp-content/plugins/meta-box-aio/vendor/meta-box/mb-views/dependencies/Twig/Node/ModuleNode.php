...
namespace MetaBox\Dependencies\Twig\Node;
...
final class ModuleNode extends Node
{
    ...
    protected function compileClassHeader(Compiler $compiler)
    {
        ...
        if (!$this->getAttribute('index')) {
            $compiler
                ->write("use MetaBox\Dependencies\Twig\Environment;\n")
                ->write("use MetaBox\Dependencies\Twig\Error\LoaderError;\n")
                ->write("use MetaBox\Dependencies\Twig\Error\RuntimeError;\n")
                ->write("use MetaBox\Dependencies\Twig\Extension\SandboxExtension;\n")
                ->write("use MetaBox\Dependencies\Twig\Markup;\n")
                ->write("use MetaBox\Dependencies\Twig\Sandbox\SecurityError;\n")
                ->write("use MetaBox\Dependencies\Twig\Sandbox\SecurityNotAllowedTagError;\n")
                ->write("use MetaBox\Dependencies\Twig\Sandbox\SecurityNotAllowedFilterError;\n")
                ->write("use MetaBox\Dependencies\Twig\Sandbox\SecurityNotAllowedFunctionError;\n")
                ->write("use MetaBox\Dependencies\Twig\Source;\n")
                ->write("use MetaBox\Dependencies\Twig\Template;\n\n")
            ;
        }
        $compiler
