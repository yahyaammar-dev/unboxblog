...
use MetaBox\Dependencies\Twig\Extension\GlobalsInterface;
use MetaBox\Dependencies\Twig\Extension\StagingExtension;
    ...
    private function initExtension(ExtensionInterface $extension): void
    {
        ...
        foreach ($extension->getTokenParsers() as $parser) {
            if (!$parser instanceof TokenParserInterface) {
                throw new \LogicException('getTokenParsers() must return an array of \MetaBox\Dependencies\Twig\TokenParser\TokenParserInterface.');
            }
