...
class Settings {
	...
	public function file_field() {
		...
		<p class="description">
			<?php _e( 'Please enter absolute path to <code>.yaml</code> files or folders containing <code>.yaml</code> files. Separate multiple files, folders with commas. Supports following variables (no trailing slash):', 'meta-box-template' ); ?>
		</p>
		<ul>
			<li>
