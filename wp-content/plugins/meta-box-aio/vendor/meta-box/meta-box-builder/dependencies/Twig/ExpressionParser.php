...
use MetaBox\Dependencies\Twig\Node\Expression\AbstractExpression;
use MetaBox\Dependencies\Twig\Node\Expression\ArrayExpression;
use MetaBox\Dependencies\Twig\Node\Expression\ArrowFunctionExpression;
use MetaBox\Dependencies\Twig\Node\Expression\AssignNameExpression;
use MetaBox\Dependencies\Twig\Node\Expression\Binary\ConcatBinary;
use MetaBox\Dependencies\Twig\Node\Expression\BlockReferenceExpression;
use MetaBox\Dependencies\Twig\Node\Expression\ConditionalExpression;
use MetaBox\Dependencies\Twig\Node\Expression\ConstantExpression;
use MetaBox\Dependencies\Twig\Node\Expression\GetAttrExpression;
use MetaBox\Dependencies\Twig\Node\Expression\MethodCallExpression;
use MetaBox\Dependencies\Twig\Node\Expression\NameExpression;
use MetaBox\Dependencies\Twig\Node\Expression\ParentExpression;
use MetaBox\Dependencies\Twig\Node\Expression\TestExpression;
...
class ExpressionParser
{
    ...
    private function getTestNodeClass(TwigTest $test): string
    {
        if ($test->isDeprecated()) {
            $stream = $this->parser->getStream();
            $message = sprintf('MetaBox\Dependencies\Twig Test "%s" is deprecated', $test->getName());
    ...
    private function getFunctionNodeClass(string $name, int $line): string
    {
        ...
        if ($function->isDeprecated()) {
            $message = sprintf('MetaBox\Dependencies\Twig Function "%s" is deprecated', $function->getName());
    ...
    private function getFilterNodeClass(string $name, int $line): string
    {
        ...
        if ($filter->isDeprecated()) {
            $message = sprintf('MetaBox\Dependencies\Twig Filter "%s" is deprecated', $filter->getName());
