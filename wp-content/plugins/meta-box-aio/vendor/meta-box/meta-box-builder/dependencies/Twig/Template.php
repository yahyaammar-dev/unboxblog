 ...
 * instead, which returns an instance of \MetaBox\Dependencies\Twig\TemplateWrapper.
 *
...
abstract class Template
{
    ...
    public function displayBlock($name, array $context, array $blocks = [], $useBlocks = true, self $templateContext = null)
    {
        ...
        if (null !== $template && !$template instanceof self) {
            throw new \LogicException('A block must be a method on a \MetaBox\Dependencies\Twig\Template instance.');
        }
        ...
        if (null !== $template) {
            try {
                ...
                // this is mostly useful for \MetaBox\Dependencies\Twig\Error\LoaderError exceptions
                // see \MetaBox\Dependencies\Twig\Error\LoaderError
