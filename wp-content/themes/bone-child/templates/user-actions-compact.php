...
<?php } else { ?>
<div class="userActions userActions--compact metaFont">
	<div class="userActions-btn btn btn--circle js-popover-toggle"><div class="userActions-avatar"><?php echo get_avatar( get_current_user_id(), 36, '', esc_html__('Avatar', 'bone') ); ?></div></div>
	<div class="userActions-popover js-popover popover popover--bottom popover--alignRight">
